...
// in a serverless environment like Next.js. It ensures that we only initialize
// the app once, preventing conflicts and errors.
...
const storageBucket = process.env.NEXT_PUBLIC_FIREBASE_STORAGE_BUCKET || "fir-5d78f.appspot.com";
